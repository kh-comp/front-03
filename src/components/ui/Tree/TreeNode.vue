  ...
  <li class="list-none">
    ...
    >
      ...
      <button
        v-if="hasChildren"
        type="button"
        class="flex-shrink-0 h-4 w-4 flex items-center justify-center text-tree-node-text"
      ...
      <input
        ...
        :checked="isChecked"
        class="h-4 w-4 rounded border-tree-border text-checkbox-checked-bg focus:ring-primary focus:ring-2"
        @change="toggleCheck"
      />
      ...
      <label
        ...
        :class="cn(
          'text-sm leading-normal text-tree-node-text cursor-pointer select-none flex-1',
        )"
